...
\fl{}\moduleLeftDash\cl{ {\MODULE} streamlet\_v2}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Sequences ,\, Integers ,\, Naturals ,\, TLC ,\, FiniteSets}
\fl{}
\fl{ {\CONSTANTS} MAXEPOCHS ,\, N}
\fl{ Nodes \.{\defeq} 1 \.{\dotdot} N}
\fl{}
\fl{}
\fl{ {\p@mmalgorithm} streamlet {\p@lbrace}}
\fl{ {\p@variable} votes \.{=} \{ \} ,\, proposal \.{=} \{ \} ,\,}
 \fl{ notarized \.{=} [ ep \.{\in} 0 \.{\dotdot} MAXEPOCHS \.{\mapsto}
 {\FALSE} ] {\p@semicolon}}
\fl{}
\fl{ {\p@define} {\p@lbrace}}
 \fl{ NoOfVotes ( ep ,\, vo ) \.{\defeq} \{ response \.{\in} votes \.{:}
 response . epoch \.{=} ep \.{\land} response . vote \.{=} vo \}}
\fl{ {\p@rbrace}}
\fl{}
\fl{ {\p@macro} Propose {\p@lparen} ep ,\, n {\p@rparen} {\p@lbrace}}
 \fl{ proposal \.{:=} proposal \.{\cup} \{ [ epoch \.{\mapsto} ep ,\, node
 \.{\mapsto} n ] \}}
\fl{ {\p@rbrace}}
\fl{}
\fl{ {\p@macro} Vote {\p@lparen} ep ,\, n ,\, v {\p@rparen} {\p@lbrace}}
 \fl{ votes \.{:=} votes \.{\cup} \{ [ epoch \.{\mapsto} ep ,\, node
 \.{\mapsto} n ,\, vote \.{\mapsto} v ] \}}
\fl{ {\p@rbrace}}
\fl{}
 \fl{ {\p@fair} {\p@process} {\p@lparen} p}\al{23}{4}{ \.{\in} Nodes
 {\p@rparen}}
\fl{ {\p@variable} epoch}\al{24}{2}{ \.{=} 0 {\p@semicolon}}
\fl{ {\p@lbrace}}
 \fl{ BEGIN\@s{.5}\textrm{:}\@s{3}}\al{26}{1}{ {\p@while} {\p@lparen} epoch
 \.{<} MAXEPOCHS {\p@rparen} {\p@lbrace}}
\fl{}
 \fl{ {\p@if} {\p@lparen}}\al{28}{2}{ epoch \.{\%} N \.{=} self {\p@rparen}
 {\p@lbrace}}
\fl{ Propose ( epoch ,\, self ) {\p@semicolon}}
\fl{ {\p@rbrace}}\al{30}{1}{ {\p@else} {\p@lbrace}}
\fl{ {\p@either} {\p@lbrace}}
\fl{ Vote ( epoch ,\, self ,\, 0 ) {\p@semicolon}}
\fl{ {\p@rbrace}}
\fl{ {\p@or}}\al{34}{1}{ {\p@lbrace}}
\fl{ Vote ( epoch ,\, self ,\, 1 ) {\p@semicolon}}
\fl{ {\p@rbrace}}
\fl{}
\fl{ {\p@rbrace}}\al{38}{1}{ {\p@semicolon}}
 \fl{ {\p@if} {\p@lparen}}\al{39}{2}{ Cardinality ( NoOfVotes ( epoch ,\, 1 )
 ) \.{\geq} N \.{\div} 2 {\p@rparen} {\p@lbrace}}
\fl{ notarized [ epoch ] \.{:=} {\TRUE} {\p@semicolon}}
\fl{}
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{ epoch \.{:=} epoch \.{+} 1 {\p@semicolon}}
\fl{ {\p@rbrace}}
\fl{ {\p@rbrace}}
\fl{ {\p@rbrace}%
\@y{}%
...
\fl{}
\fl{}
\fl{ {\VARIABLES} votes ,\, proposal ,\, notarized ,\, pc}
\fl{}
\fl{}
 \fl{ NoOfVotes ( ep ,\, vo ) \.{\defeq} \{ response \.{\in} votes \.{:}
 response . epoch \.{=} ep \.{\land} response . vote \.{=} vo \}}
...
\fl{ {\VARIABLE} epoch}
\fl{}
 \fl{ vars \.{\defeq} {\langle} votes ,\, proposal ,\, notarized ,\, pc ,\,
 epoch {\rangle}}
\fl{}
\fl{ ProcSet \.{\defeq} ( Nodes )}
\fl{}
\fl{ Init \.{\defeq}}\al{61}{2}{%
\@y{\@s{0}%
 Global variables
}%
}
\fl{ \.{\land}}\al{62}{1}{ votes \.{=} \{ \}}
\fl{ \.{\land}}\al{63}{1}{ proposal \.{=} \{ \}}
 \fl{ \.{\land}}\al{64}{1}{ notarized \.{=} [ ep \.{\in} 0 \.{\dotdot}
 MAXEPOCHS \.{\mapsto} {\FALSE} ]}
\fl{}
\fl{ \.{\land}}\al{66}{1}{ epoch \.{=} [ self \.{\in} Nodes \.{\mapsto} 0 ]}
 \fl{ \.{\land}}\al{67}{1}{ pc \.{=} [ self \.{\in} ProcSet
 \.{\mapsto}\@w{BEGIN} ]}
\fl{}
 \fl{ BEGIN ( self ) \.{\defeq}}\al{69}{5}{ \.{\land}}\al{69}{6}{ pc [ self ]
 \.{=}\@w{BEGIN}}
\fl{ \.{\land}}\al{70}{1}{ {\IF}}\al{70}{2}{ epoch [ self ] \.{<} MAXEPOCHS}
 \fl{ \.{\THEN}}\al{71}{1}{ \.{\land}}\al{71}{2}{ {\IF}}\al{71}{3}{ epoch [
 self ] \.{\%} N \.{=} self}
 \fl{ \.{\THEN}}\al{72}{1}{ \.{\land}}\al{72}{2}{ proposal \.{'} \.{=} (
 proposal \.{\cup} \{ [ epoch \.{\mapsto} epoch [ self ] ,\, node \.{\mapsto}
 self ] \} )}
\fl{ \.{\land}}\al{73}{1}{ votes \.{'} \.{=} votes}
 \fl{ \.{\ELSE}}\al{74}{1}{ \.{\land}}\al{74}{2}{ \.{\lor}}\al{74}{3}{
 \.{\land}}\al{74}{4}{ votes \.{'}}\al{74}{6}{ \.{=}}\al{74}{7}{ (
 votes}\al{74}{9}{ \.{\cup}}\al{74}{10}{ \{ [ epoch}\al{74}{13}{
 \.{\mapsto}}\al{74}{14}{ epoch [ self ] ,\, node}\al{74}{20}{
 \.{\mapsto}}\al{74}{21}{ self ,\, vote}\al{74}{24}{ \.{\mapsto}}\al{74}{25}{
 0 ] \} )}
 \fl{ \.{\lor}}\al{75}{1}{ \.{\land}}\al{75}{2}{ votes \.{'}}\al{75}{4}{
 \.{=}}\al{75}{5}{ ( votes}\al{75}{7}{ \.{\cup}}\al{75}{8}{ \{ [
 epoch}\al{75}{11}{ \.{\mapsto}}\al{75}{12}{ epoch [ self ] ,\,
 node}\al{75}{18}{ \.{\mapsto}}\al{75}{19}{ self ,\, vote}\al{75}{22}{
 \.{\mapsto}}\al{75}{23}{ 1 ] \} )}
\fl{ \.{\land}}\al{76}{1}{ {\UNCHANGED} proposal}
 \fl{ \.{\land}}\al{77}{1}{ {\IF}}\al{77}{2}{ Cardinality ( NoOfVotes ( epoch
 [ self ] ,\, 1 ) ) \.{\geq} N \.{\div} 2}
 \fl{ \.{\THEN}}\al{78}{1}{ \.{\land}}\al{78}{2}{ notarized \.{'} \.{=} [
 notarized {\EXCEPT} {\bang} [ epoch [ self ] ] \.{=} {\TRUE} ]}
\fl{ \.{\ELSE}}\al{79}{1}{ \.{\land}}\al{79}{2}{ {\TRUE}}
\fl{ \.{\land}}\al{80}{1}{ {\UNCHANGED} notarized}
 \fl{ \.{\land}}\al{81}{1}{ epoch \.{'} \.{=} [ epoch {\EXCEPT} {\bang} [ self
 ] \.{=} epoch [ self ] \.{+} 1 ]}
 \fl{ \.{\land}}\al{82}{1}{ pc \.{'}}\al{82}{3}{ \.{=}}\al{82}{4}{ [ pc
 {\EXCEPT} {\bang} [ self ]}\al{82}{11}{ \.{=}}\al{82}{12}{\@w{BEGIN} ]}
 \fl{ \.{\ELSE}}\al{83}{1}{ \.{\land}}\al{83}{2}{ pc \.{'}}\al{83}{4}{
 \.{=}}\al{83}{5}{ [ pc {\EXCEPT} {\bang} [ self ]}\al{83}{12}{
 \.{=}}\al{83}{13}{\@w{Done} ]}
 \fl{ \.{\land}}\al{84}{1}{ {\UNCHANGED} {\langle} votes ,\, proposal ,\,
 notarized ,\, epoch {\rangle}}
\fl{}
\fl{ p ( self ) \.{\defeq} BEGIN ( self )}
\fl{}
\fl{}
 \fl{ Terminating \.{\defeq}}\al{89}{2}{ \.{\land}}\al{89}{3}{ \A\, self
 \.{\in} ProcSet \.{:} pc [ self ] \.{=}\@w{Done}}
\fl{ \.{\land}}\al{90}{1}{ {\UNCHANGED} vars}
\fl{}
 \fl{ Next}\al{92}{1}{ \.{\defeq}}\al{92}{2}{ (}\al{92}{3}{ \E\, self \.{\in}
 Nodes \.{:} p ( self ) )}
\fl{ \.{\lor} Terminating}
\fl{}
 \fl{ Spec}\al{95}{1}{ \.{\defeq}}\al{95}{2}{ \.{\land}}\al{95}{3}{ Init
 \.{\land} {\Box} [ Next ]_{ vars}}
 \fl{ \.{\land}}\al{96}{1}{ \A\, self \.{\in} Nodes \.{:} {\WF}_{ vars} ( p (
 self ) )}
\fl{}
